    ...
    (if(empty? listaArchEnt)
       ...
       (let*
           ...
           ([car_de_lista (car listaArchEnt)]
            ...
            [car_de_lista (regexp-replace* #px"[^[:word:]]for[^[:word:]]" car_de_lista "<span class='condicional'>&</span>")]
            [car_de_lista (regexp-replace* #px"[^[:word:]]if[^[:word:]]" car_de_lista "<span class='condicional'>&</span>")]
            [car_de_lista (regexp-replace* #px"[^[:word:]]else[^[:word:]]" car_de_lista "<span class='condicional'>&</span>")]
            [car_de_lista (regexp-replace* #px"[^[:word:]]while[^[:word:]]" car_de_lista "<span class='condicional'>&</span>"	)]
            [car_de_lista (regexp-replace* #px"[^[:word:]]switch[^[:word:]]" car_de_lista "<span class='condicional'>&</span>")]
            [car_de_lista (regexp-replace* #px"[^[:word:]]break[^[:word:]]" car_de_lista "<span class='condicional'>&</span>"	)]
            [car_de_lista (regexp-replace* #px"[^[:word:]]continue[^[:word:]]" car_de_lista "<span class='condicional'>&</span>")]
            [car_de_lista (regexp-replace* #px"[^[:word:]]return[^[:word:]]" car_de_lista "<span class='condicional'>&</span>")]
            [car_de_lista (regexp-replace* #px"[^[:word:]]break[^[:word:]]" car_de_lista "<span class='condicional'>&</span>")]
            [car_de_lista (regexp-replace* #px"[^[:word:]]bool[^[:word:]]" car_de_lista "<span class='booleano'>&</span>")]
